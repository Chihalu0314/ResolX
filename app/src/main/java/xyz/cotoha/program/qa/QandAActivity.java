...
public class QandAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qandaList.add(new QandA("Q1：メールが届きません", "A：上の文字をタップして詳細を見てください"));
        qandaList.add(new QandA("Q2：システムアップデートとはなんですか？", "A：上の文字をタップして詳細を見てください"));
        qandaList.add(new QandA("Q3：アプリのアップデートとはなんですか？", "A：上の文字をタップして詳細を見てください"));
